...
void main() {
  ...
  testWidgets('TrackResultTile displays artwork, explicit badge, album, duration and key',
      (tester) async {
    const track = TrackSummary(
      ...
      key: 'G Major',
      artworkUrl:
          'https://resources.tidal.com/images/7d3b9810/5634/400c/ad89/50609e0ce800/640x640.jpg',
  ...
  testWidgets('PlayerPanel displays large artwork, acoustic readings and catalog metadata',
      (tester) async {
    const track = TrackSummary(
      id: 'local:abc',
      provider: 'local',
